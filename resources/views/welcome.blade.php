        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="text-sm text-gray-700 underline">Inicio de Sesión</a>
            ...
            @endif
            <img src="/storage/default-welcome.jpg" alt="Foto de Bienvenida" style="width: 180vh;">
        </div>
    </body>
</html>
